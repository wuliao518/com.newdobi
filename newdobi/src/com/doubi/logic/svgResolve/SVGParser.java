...
public class SVGParser {
	...
	private static List<Path> mPaths;
	 ...
	 *             if there is an error while parsing.
	 */
	public static SVG getSVGFromResource(InputStream mInputStream)
			throws SVGParseException {
		return SVGParser.parse(mInputStream, 0, 0, false);
	}
	...
	private static SVG parse(InputStream in, Integer searchColor,
		...
		try {
			...
			// start) + " millis.");
			SVG result = new SVG(picture, handler.bounds, mPaths);
